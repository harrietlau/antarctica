function plot_plates_HL(posterior_L, q_method,outdir)
...
x = posterior_L.zPlate;
y = posterior_L.p_zPlate;
save([outdir '/posterior/zplate_x.dat'],'x','-ascii');
save([outdir '/posterior/zplate_y.dat'],'y','-ascii');
...
x = posterior_L.Tp;
y = posterior_L.p_Tp;
save([outdir '/posterior/Tp_x.dat'],'x','-ascii');
save([outdir '/posterior/Tp_y.dat'],'y','-ascii');
...
x = posterior_L.zLAB;
y = posterior_L.p_zLAB;
save([outdir '/posterior/zlab_x.dat'],'x','-ascii');
save([outdir '/posterior/zlab_y.dat'],'y','-ascii');
