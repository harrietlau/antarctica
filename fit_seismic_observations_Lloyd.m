function posterior = fit_seismic_observations_Lloyd(filenames, location, q_method,outdir)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
%
% Jan 2020 HL has edited from the original
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fname = 'data/plate_VBR/sweep_longperiod_Lloyd.mat';
if ~exist(fname, 'file')
    % sweep_params.T = 1000:50:1700; %[degrees C]
    sweep_params.T = 700:50:1800; %[degrees C] %% HL has expanded this sweep
    ...
    sweep_params.per_bw_max = 5; % max period of range of mask (s) LLOYD
    sweep_params.per_bw_min = 0.5; % min period of range of mask (s) LLOYD
...
if VsExists
    ...
    %plot_Bayes(posterior_S_given_Vs, sweep, vs_str, q_method) HL
    %plot_tradeoffs_posterior(posterior_S_given_Vs, sweep, vs_str,
    %q_method) HL
    posterior.pS = posterior_S_given_Vs;
    %% HARRIET ADDING THE FOLLOWING TO SAVE POSTERIOR OUTPUTS
    save([outdir '/posterior/posterior.mat'],'posterior_S_given_Vs');
    ofields = {'T','phi','gs'};
    MAT = make_param_grid(ofields,sweep);
    save([outdir '/posterior/param.mat'],'MAT');
end
...
if VsExists && isfield(filenames, 'Q')
    ...
    %plot_Bayes(posterior_S_given_Vs_and_Q, sweep, vs_q_str, q_method) HL

    %plot_tradeoffs_posterior(posterior_S_given_Vs_and_Q, sweep, ...
    %    vs_q_str, q_method) HL
